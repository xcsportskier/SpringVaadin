package com.vaadin.training.productdb.ui.utils;
...
public class FormattingUtils {
	 ...
	 */
	public static final TemporalField WEEK_OF_YEAR_FIELD = WeekFields.of(AppUIConst.APP_LOCALE).weekOfWeekBasedYear();
	...
	public static String getFullMonthName(LocalDate date) {
		return date.getMonth().getDisplayName(TextStyle.FULL, AppUIConst.APP_LOCALE);
	}

	
	public static String formatAsCurrency(BigDecimal value) {
		return NumberFormat.getCurrencyInstance(AppUIConst.APP_LOCALE).format(value);
	}
	

	public static DecimalFormat getUiPriceFormatter() {
		DecimalFormat formatter = new DecimalFormat("#" + DECIMAL_ZERO,
				DecimalFormatSymbols.getInstance(AppUIConst.APP_LOCALE));
